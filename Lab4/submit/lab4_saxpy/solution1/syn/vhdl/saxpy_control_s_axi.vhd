...
end entity saxpy_control_s_axi;
...
architecture behave of saxpy_control_s_axi is
    ...
    constant ADDR_A_DATA_0 : INTEGER := 16#28#;
    constant ADDR_A_CTRL   : INTEGER := 16#2c#;

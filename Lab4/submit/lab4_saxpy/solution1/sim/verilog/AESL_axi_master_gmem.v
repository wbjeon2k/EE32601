...
//------------------------Parameter----------------------
`define TV_IN_gmem "../tv/cdatafile/c.saxpy.autotvin_gmem.dat"
`define TV_OUT_gmem "../tv/rtldatafile/rtl.saxpy.autotvout_gmem.dat"
...
parameter gmem_mem_depth = 32'd 40;
...
output [64 - 1 : 0] TRAN_gmem_x;
output [64 - 1 : 0] TRAN_gmem_y;
input ready;
input done;
...
assign    TRAN_gmem_x = x;
assign    TRAN_gmem_y = y;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem_mem_depth) begin
                $display ("C:/Users/JEONWOONGBAE/AppData/Roaming/Xilinx/Vitis/lab4_saxpy/solution1/sim/verilog/AESL_axi_master_gmem.v: Write request address %d exceed AXI master gmem array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem_mem_depth) begin
                $display ("C:/Users/JEONWOONGBAE/AppData/Roaming/Xilinx/Vitis/lab4_saxpy/solution1/sim/verilog/AESL_axi_master_gmem.v: Read request address %d exceed AXI master gmem array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem_mem_depth); 
                $finish;
            end

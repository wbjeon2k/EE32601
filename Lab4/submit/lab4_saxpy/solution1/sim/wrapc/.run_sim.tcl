...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "saxpy.autotvin.dat"
	set constFileTvOut       "saxpy.autotvout.dat"
	set constFileHdlTvIn     "saxpy.autohdltvin.dat"
	set constFileHdlTvOut    "saxpy.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

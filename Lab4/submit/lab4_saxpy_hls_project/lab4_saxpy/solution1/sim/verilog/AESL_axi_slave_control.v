...
//------------------------Parameter----------------------
`define TV_IN_x "../tv/cdatafile/c.saxpy.autotvin_x.dat"
`define TV_IN_y "../tv/cdatafile/c.saxpy.autotvin_y.dat"
`define TV_IN_a "../tv/cdatafile/c.saxpy.autotvin_a.dat"
...
parameter saxpy_continue_addr = 0;
parameter saxpy_auto_start_addr = 0;
parameter x_data_in_addr = 16;
parameter y_data_in_addr = 28;
parameter a_data_in_addr = 40;
...
assign TRAN_control_write_data_finish = 1 & x_write_data_finish & y_write_data_finish & a_write_data_finish;

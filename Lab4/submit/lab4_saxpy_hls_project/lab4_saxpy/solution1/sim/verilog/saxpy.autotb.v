...
`define AUTOTB_DUT      saxpy
`define AUTOTB_DUT_INST AESL_inst_saxpy
`define AUTOTB_TOP      apatb_saxpy_top
`define AUTOTB_LAT_RESULT_FILE "saxpy.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "saxpy.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_saxpy_top
...
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.saxpy.autotvin_gmem.dat"
`define AUTOTB_TVIN_x_out_wrapc  "../tv/rtldatafile/rtl.saxpy.autotvin_x.dat"
`define AUTOTB_TVIN_y_out_wrapc  "../tv/rtldatafile/rtl.saxpy.autotvin_y.dat"
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.saxpy.autotvin_a.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.saxpy.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.saxpy.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 39;
parameter LENGTH_gmem = 40;

...
if {[file isfile gcd_custom.autotvin.dat]} {
	file delete -force gcd_custom.autotvin.dat
}

if {[file isfile gcd_custom.autotvout.dat]} {
	file delete -force gcd_custom.autotvout.dat
}

...
`define AUTOTB_DUT      gcd_custom
`define AUTOTB_DUT_INST AESL_inst_gcd_custom
`define AUTOTB_TOP      apatb_gcd_custom_top
`define AUTOTB_LAT_RESULT_FILE "gcd_custom.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "gcd_custom.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_gcd_custom_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_a 1
`define AESL_DEPTH_b 1
`define AESL_DEPTH_gcd 1
...
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.gcd_custom.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "../tv/rtldatafile/rtl.gcd_custom.autotvin_b.dat"
`define AUTOTB_TVOUT_gcd  "../tv/cdatafile/c.gcd_custom.autotvout_gcd.dat"
`define AUTOTB_TVOUT_gcd_out_wrapc  "../tv/rtldatafile/rtl.gcd_custom.autotvout_gcd.dat"
module `AUTOTB_TOP;
...
reg dump_tvout_finish_gcd;

initial begin : dump_tvout_runtime_sign_gcd
    integer fp;
    dump_tvout_finish_gcd = 0;
    fp = $fopen(`AUTOTB_TVOUT_gcd_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_gcd_out_wrapc);
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_gcd_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_gcd_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;

...
# ==============================================================
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vitis/2020.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vitis/2020.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vitis/2020.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vitis/2020.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "gcd_custom.autotvin.dat"
	set constFileTvOut       "gcd_custom.autotvout.dat"
	set constFileHdlTvIn     "gcd_custom.autohdltvin.dat"
	set constFileHdlTvOut    "gcd_custom.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

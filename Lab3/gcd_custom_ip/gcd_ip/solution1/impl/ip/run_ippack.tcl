...
set Library     "hls"
set IPName      "gcd_custom"
set Version     "1.0"
set DisplayName "Gcd_custom"
set Revision    "2112430460"
...
set xo_kernel_name "gcd_custom"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Xilinx/Vitis/2020.1/gcd_custom_ip/gcd_ip/solution1"
set debug_dir "C:/Xilinx/Vitis/2020.1/gcd_custom_ip/gcd_ip/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {gcd_custom_srem_32ns_32ns_32_36_1
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 a W 0x0 "Data signal of a" {{0 32 a W 0 "Bit 31 to 0 of a"}}} {0x18 b W 0x0 "Data signal of b" {{0 32 b W 0 "Bit 31 to 0 of b"}}} {0x20 gcd R 0x0 "Data signal of gcd" {{0 32 gcd R 0 "Bit 31 to 0 of gcd"}}} {0x24 gcd_ctrl R 0x0 "Control signal of gcd" {{0 1 gcd_ap_vld R 0 "Control signal gcd_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
source -notrace "C:/Xilinx/Vitis/2020.1/common/scripts/ipxhls.tcl"
